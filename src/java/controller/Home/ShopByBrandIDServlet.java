...
public class ShopByBrandIDServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sortType.equals("desc")) {
            list = ProductDAO.getAllProductByBrandID("price", Integer.parseInt(brandID));
        } else {
            list = ProductDAO.getAllProductAscByBrandID("price", Integer.parseInt(brandID));
        }
        ...
        request.setAttribute("productList", (sortType.equals("desc")) ? (ProductDAO.getAllProductByBrandID("price", Integer.parseInt(brandID))) : (ProductDAO.getAllProductAscByBrandID("price", Integer.parseInt(brandID))));
        request.setAttribute("productDAO", new ProductDAO());
        request.setAttribute("brandList", BrandDAO.getListBrand());
        request.setAttribute("numOfProduct", ProductDAO.getAllProductByBrandID("price", Integer.parseInt(brandID)).size());
