                    ...
                    <div class="col-lg-12">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__links">
                                <a href="home">Home</a>
                                <a href="shopbybrandID?brandID=${brand.brandID}">${name}</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="shop__product__option__right">
                                            ...
                                            <select onchange="location = this.value;">
                                                <option value="shopbybrandID?brandID=${brandID}&sortType=desc">High To Low</option>
                                                <option value="shopbybrandID?brandID=${brandID}&sortType=asc" ${sortType.equals("asc")?"selected":""}>Low To High</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="product__pagination">
                                        <c:forEach begin="1" end="${size}" var="i">
                                            <a class="${i==page?"active":""}" href="shopbybrandID?page=${i}&sortType=${sortType}&brandID=${brandID}">${i}</a>
                                        </c:forEach>
                                    </div>
                                </div>
                            </div>
                    ...
                    <c:if test="${numOfProduct==0}">
                        <div class="col-lg-9">
                            <p>
                                There are no product in this brand
                            </p>
                        </div>
                    </c:if>
                </div>
