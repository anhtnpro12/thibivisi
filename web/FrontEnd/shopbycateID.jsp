                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="shop__product__option__right">
                                            ...
                                            <select onchange="location = this.value;">
                                                <option value="${url}-desc">High To Low</option>
                                                <option value="${url}-asc" ${sortType.equals("asc")?"selected":""}>Low To High</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="product__pagination">
                                        <c:forEach begin="1" end="${size}" var="i">
                                            <a class="${i==page?"active":""}" href="${url}-${sortType}-page${i}">${i}</a>
                                        </c:forEach>
                                    </div>
                                </div>
                            </div>
