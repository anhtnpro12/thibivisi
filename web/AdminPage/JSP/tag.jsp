                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="card" style="margin: 2.5%">
                            <a href="admin-view-tag"><h5 class="card-header">TAG LIST</h5></a>
                                ...
                                <nav aria-label="Page navigation" class="${list.size()==0?"d-none":""}">
                                    <ul class="pagination justify-content-end me-3">
                                        <li class="page-item prev">
                                            <a class="page-link" href="/SWP/admin-view-tag?page=${page-1==0?size:page-1}"><i class="tf-icon bx bx-chevrons-left"></i></a>
                                        </li>
                                        <c:forEach begin="1" end="${size}" var="i">
                                            <li class="page-item ${i==page?"active":""}">
                                                <a class="page-link" href="/SWP/admin-view-tag?page=${i}">${i}</a>
                                            </li>
                                        </c:forEach>
                                        <li class="page-item next">
                                            <a class="page-link" href="/SWP/admin-view-tag?page=${page+1>size?1:page+1}"><i class="tf-icon bx bx-chevrons-right"></i></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
