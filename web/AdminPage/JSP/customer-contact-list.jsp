                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="card" style="margin: 2.5%">
                            ...
                            <div class="row g-0 card-body">
                                <div class="col-6 col-md-4 d-flex"><div class="align-self-center">${categoryDao.getCateIDMax()} ${categoryDao.getCateIDMax()>1?"Contacts":"Contact"}</div></div>
                                    ...
                                    <tbody class="table-border-bottom-0">       
                                        <c:forEach items="${list}" var="contact">
                                            <tr>
                                                ...
                                                <td>
                                                    <a title="Edit" class="btn btn-sm btn-outline-primary" href="admin-detail-contact?contactID=${contact.contactID}">
                                                        <i class="bx bx-edit-alt"></i>
                                                    </a>
                                                    <a title="Delete" class="btn btn-sm btn-outline-danger" 
                                                       href="admin-delete-contact?contactID=${contact.contactID}" onclick="return confirm('Are you sure you want to delete this message?')">
                                ...
                                <nav aria-label="Page navigation" class="${list.size()==0?"d-none":""}">
                                    <ul class="pagination justify-content-end me-3">
                                        <li class="page-item prev">
                                            <a class="page-link" href="/SWP/admin-view-contact?page=${page-1==0?size:page-1}"><i class="tf-icon bx bx-chevrons-left"></i></a>
                                        </li>
                                        <c:forEach begin="1" end="${size}" var="i">
                                            <li class="page-item ${i==page?"active":""}">
                                                <a class="page-link" href="/SWP/admin-view-contact?page=${i}">${i}</a>
                                            </li>
                                        </c:forEach>
                                        <li class="page-item next">
                                            <a class="page-link" href="/SWP/admin-view-contact?page=${page+1>size?1:page+1}"><i class="tf-icon bx bx-chevrons-right"></i></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
