                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="card" style="margin: 2.5%">
                            <h5 class="card-header">UPDATE ABOUT US>${news.title}</h5>
                            <div class="d-flex justify-content-between">
                                <ul class="card-body nav nav-pills">
                                    <li class="nav-item">
                                        <a href="admin-view-product?page-type=all"><button class="nav-link ${pageType.equals("all")?"active":""}">Company Profile</button></a>                                      
                                    </li>
                                    <li class="nav-item">
                                        <a href="admin-view-product?page-type=false"><button class="nav-link ${pageType.equals("false")?"active":""}">Goal</button></a>       
                                    </li>
                                    <li class="nav-item">
                                        <a href="admin-view-product?page-type=true"><button class="nav-link ${pageType.equals("true")?"active":""}">Mission</button></a>       
                                    </li>
                                </ul>
                            </div>
