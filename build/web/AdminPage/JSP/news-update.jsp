...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="AdminPage/assets/"
    ...
    <body>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-4">
                                        ...
                                        <!-- Product -->
                                        <form action="admin-update-news" id="formAccountSettings" method="POST" enctype="multipart/form-data">                                            
                                            <hr class="my-0" />
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-3 col-md-6">
                                                        <label for="productCode" class="form-label">News Code</label>
                                                        <input class="form-control" type="text" id="Code"
                                                               name="Code" value="${requestScope.news.code}" readonly/>
                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                        <label for="productName" class="form-label">Title</label>
                                                        <input class="form-control" type="text" name="title"
                                                               id="title" value="${requestScope.news.title}" autofocus/>
                                                    </div>
                                                    <div class="mb-3 col-md-12">
                                                        <label for="shortDescription" class="form-label">Short description</label>
                                                        <textarea class="form-control" name="shortdescript" id="shortdescript" cols="10" rows="3">${requestScope.news.shortDescription}</textarea>
                                                    </div>
                                                    <div class="mb-3 col-md-12">
                                                        <label for="description" class="form-label">Description</label>
                                                        <textarea class="form-control" name="description" id="description" cols="10" rows="6">${requestScope.news.description}</textarea>
                                                    </div>
                                                    <input name="createdAt" type="text" style="display: none" value="${requestScope.news.createdAt}"/>
                                                    <input name="createdBy" type="text" style="display: none" value="${requestScope.news.createdBy}"/>
                                                    <input name="newsID" type="text" style="display: none" value="${requestScope.news.newsID}"/>
                                                </div>
                                                <div class="mt-2">
                                                    <button type="submit" class="btn btn-primary me-2">Save News</button>
                                                    <button type="button" onclick="location.href = 'admin-update-aboutus'" class="btn btn-outline-secondary">
                                                        Back
                                                    </button>
                                                </div>
                                            </div>
        ...
        <script>            
            ...
            var files = [
                <c:forEach  items="${news.images}" var="img">                           
                {
                    source: "News image",
                    options: {
                        type: "input",
                        ...
                        metadata: {
                            poster: "./img/UploadImgs/NewsImgs//${news.code}/${img.image}"
                        }
                    }
                }, 
                </c:forEach>
