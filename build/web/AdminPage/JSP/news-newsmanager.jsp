                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="card" style="margin: 2.5%">
                            <h5 class="card-header">News Manager</h5>
                            <a class="card-body d-flex justify-content-end" href="admin-create-news"><button type="button" class="btn rounded-pill btn-danger">Add News</button></a>
