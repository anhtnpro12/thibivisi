                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">CONTACT LIST /</span>
                                CONTACT</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card mb-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input class="form-control" type="text" name="email"
                                                           id="email" value="${contact.email}" readonly/>
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label for="date" class="form-label">Send Date (YYYY-MM-DD)</label>
                                                    <input class="form-control" type="text" name="date"
                                                           id="date" value="${contact.createdAt}" readonly/>
                                                </div>
                                                <div class="mb-3 col-md-12">
                                                    <label for="message" class="form-label">Message</label>
                                                    <textarea class="form-control" name="message" id="customer-message" cols="10" rows="6" readonly>${contact.message}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <c:forEach  items="${repcontact}" var="repcontact">
                                            <hr class="my-0" />
                                            <div class="card-body">
                                                <div class="row">
                                                    <h5>Replied Contact</h5>
                                                    <div class="mb-3 col-md-6">
                                                        <label for="title" class="form-label">Send Date (YYYY-MM-DD)</label>
                                                        <input class="form-control" type="text" name="date"
                                                               id="title" value="${repcontact.createdAt}" readonly/>

                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                        <label for="by" class="form-label">Send by</label>
                                                        <input class="form-control" type="text" name="by"
                                                               id="by" value="${UserDAO.getUserByID(repcontact.createdBy).fullname}" readonly/>

                                                    </div>
                                                    <div class="mb-3 col-md-12">
                                                        <label for="title" class="form-label">Title</label>
                                                        <input type="text" name="title" class="form-control"
                                                               id="title" value="${repcontact.title}" readonly/>

                                                    </div>
                                                    <div class="mb-3 col-md-12">
                                                        <label for="message" class="form-label">Message</label>
                                                        <textarea class="form-control" name="message" id="" cols="10" rows="6" readonly>${repcontact.message}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </c:forEach>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <h5>Write reply Contact</h5>
                                                <form action="admin-detail-contact" method="POST" id="form" onsubmit="return confirm("Are you sure you want to send this message?")">
                                                    <!--                                                    <div class="mb-3 col-md-12">
                                                                                                            <label for="choosemail" class="d-block form-label">Choose email to send</label>
                                                                                                            <select name="email" id="email" class="selectpicker" data-width="100%" 
                                                                                                                    data-style="border" data-show-subtext="true"
                                                                                                                    data-size="5">
                                                                                                                <option value="minhtche164004@fpt.edu.vn">minhtche164004@fpt.edu.vn</option>
                                                                                                                <option value="trinhminh2907@gmail.com">trinhminh2907@gmail.com</option>
                                                                                                            </select>
                                                                                                        </div>-->
                                                    <div class="mb-3 col-md-12">
                                                        <label for="title" class="form-label">Title</label>
                                                    ...
                                                    <div class="mb-3 col-md-12">
                                                        <label for="message" class="form-label">Message</label>
                                                        <textarea class="form-control" name="message" id="message" cols="10" rows="6" required></textarea>
                                                    </div>
                                                    <input name="contactID" type="text" style="display: none" value="${requestScope.contact.contactID}"/>
                                                    <div class="mt-2">
